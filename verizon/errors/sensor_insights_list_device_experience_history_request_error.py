...
SensorInsightsListDeviceExperienceHistoryRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsListDeviceExperienceHistoryRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsListDeviceExperienceHistoryRequestErrorBody:
...
sensor_insights_list_device_experience_history_request_error_mapper: Final[
    ErrorMapper[SensorInsightsListDeviceExperienceHistoryRequestErrorBody]
] = _SensorInsightsListDeviceExperienceHistoryRequestError()
