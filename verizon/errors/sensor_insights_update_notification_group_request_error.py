...
SensorInsightsUpdateNotificationGroupRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsUpdateNotificationGroupRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsUpdateNotificationGroupRequestErrorBody:
...
sensor_insights_update_notification_group_request_error_mapper: Final[
    ErrorMapper[SensorInsightsUpdateNotificationGroupRequestErrorBody]
] = _SensorInsightsUpdateNotificationGroupRequestError()
