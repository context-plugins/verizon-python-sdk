...
SensorInsightsListSensorDevicesRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsListSensorDevicesRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsListSensorDevicesRequestErrorBody:
...
sensor_insights_list_sensor_devices_request_error_mapper: Final[
    ErrorMapper[SensorInsightsListSensorDevicesRequestErrorBody]
] = _SensorInsightsListSensorDevicesRequestError()
