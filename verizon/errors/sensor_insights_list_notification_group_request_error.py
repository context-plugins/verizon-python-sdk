...
SensorInsightsListNotificationGroupRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsListNotificationGroupRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsListNotificationGroupRequestErrorBody:
...
sensor_insights_list_notification_group_request_error_mapper: Final[
    ErrorMapper[SensorInsightsListNotificationGroupRequestErrorBody]
] = _SensorInsightsListNotificationGroupRequestError()
