...
SensorInsightsListRulesRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsListRulesRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsListRulesRequestErrorBody:
...
sensor_insights_list_rules_request_error_mapper: Final[
    ErrorMapper[SensorInsightsListRulesRequestErrorBody]
] = _SensorInsightsListRulesRequestError()
