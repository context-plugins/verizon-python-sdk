...
SensorInsightsBulkUpdateErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsBulkUpdateError:
    def map(self, response: HttpResponse) -> SensorInsightsBulkUpdateErrorBody:
...
sensor_insights_bulk_update_error_mapper: Final[
    ErrorMapper[SensorInsightsBulkUpdateErrorBody]
] = _SensorInsightsBulkUpdateError()
