...
SensorInsightsListSmartAlertsRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsListSmartAlertsRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsListSmartAlertsRequestErrorBody:
...
sensor_insights_list_smart_alerts_request_error_mapper: Final[
    ErrorMapper[SensorInsightsListSmartAlertsRequestErrorBody]
] = _SensorInsightsListSmartAlertsRequestError()
