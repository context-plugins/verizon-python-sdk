...
SensorInsightsSensorOffBoardingStatusRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsSensorOffBoardingStatusRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsSensorOffBoardingStatusRequestErrorBody:
...
sensor_insights_sensor_off_boarding_status_request_error_mapper: Final[
    ErrorMapper[SensorInsightsSensorOffBoardingStatusRequestErrorBody]
] = _SensorInsightsSensorOffBoardingStatusRequestError()
