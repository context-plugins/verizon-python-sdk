...
SensorInsightsListNetworkExperienceHistoryRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsListNetworkExperienceHistoryRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsListNetworkExperienceHistoryRequestErrorBody:
...
sensor_insights_list_network_experience_history_request_error_mapper: Final[
    ErrorMapper[SensorInsightsListNetworkExperienceHistoryRequestErrorBody]
] = _SensorInsightsListNetworkExperienceHistoryRequestError()
