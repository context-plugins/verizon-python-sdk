...
SensorInsightsSensorOnBoardStatusRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsSensorOnBoardStatusRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsSensorOnBoardStatusRequestErrorBody:
...
sensor_insights_sensor_on_board_status_request_error_mapper: Final[
    ErrorMapper[SensorInsightsSensorOnBoardStatusRequestErrorBody]
] = _SensorInsightsSensorOnBoardStatusRequestError()
