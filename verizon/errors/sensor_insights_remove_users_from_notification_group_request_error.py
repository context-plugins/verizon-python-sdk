...
SensorInsightsRemoveUsersFromNotificationGroupRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsRemoveUsersFromNotificationGroupRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsRemoveUsersFromNotificationGroupRequestErrorBody:
...
sensor_insights_remove_users_from_notification_group_request_error_mapper: Final[
    ErrorMapper[SensorInsightsRemoveUsersFromNotificationGroupRequestErrorBody]
] = _SensorInsightsRemoveUsersFromNotificationGroupRequestError()
