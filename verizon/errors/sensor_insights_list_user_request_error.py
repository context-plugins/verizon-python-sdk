...
SensorInsightsListUserRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsListUserRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsListUserRequestErrorBody:
...
sensor_insights_list_user_request_error_mapper: Final[
    ErrorMapper[SensorInsightsListUserRequestErrorBody]
] = _SensorInsightsListUserRequestError()
