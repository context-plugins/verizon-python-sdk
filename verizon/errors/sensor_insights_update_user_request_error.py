...
SensorInsightsUpdateUserRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsUpdateUserRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsUpdateUserRequestErrorBody:
...
sensor_insights_update_user_request_error_mapper: Final[
    ErrorMapper[SensorInsightsUpdateUserRequestErrorBody]
] = _SensorInsightsUpdateUserRequestError()
