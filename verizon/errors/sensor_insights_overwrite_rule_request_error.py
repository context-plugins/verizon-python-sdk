...
SensorInsightsOverwriteRuleRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsOverwriteRuleRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsOverwriteRuleRequestErrorBody:
...
sensor_insights_overwrite_rule_request_error_mapper: Final[
    ErrorMapper[SensorInsightsOverwriteRuleRequestErrorBody]
] = _SensorInsightsOverwriteRuleRequestError()
