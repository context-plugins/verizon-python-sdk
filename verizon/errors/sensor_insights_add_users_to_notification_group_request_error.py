...
SensorInsightsAddUsersToNotificationGroupRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError404 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsAddUsersToNotificationGroupRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsAddUsersToNotificationGroupRequestErrorBody:
...
sensor_insights_add_users_to_notification_group_request_error_mapper: Final[
    ErrorMapper[SensorInsightsAddUsersToNotificationGroupRequestErrorBody]
] = _SensorInsightsAddUsersToNotificationGroupRequestError()
