...
SensorInsightsCreateUserRequestErrorBody: TypeAlias = (
    ManagementError400 | ManagementError | ManagementError403 | ManagementError500 | RawError
)


@dataclass(frozen=True, slots=True)
class _SensorInsightsCreateUserRequestError:
    def map(self, response: HttpResponse) -> SensorInsightsCreateUserRequestErrorBody:
...
sensor_insights_create_user_request_error_mapper: Final[
    ErrorMapper[SensorInsightsCreateUserRequestErrorBody]
] = _SensorInsightsCreateUserRequestError()
