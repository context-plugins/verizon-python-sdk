...
class Environment(Enum):
    ...
    DEV = 2
    QA = 3
    MOCK_SERVER_FOR_LIMITED_AVAILABILITY_SEE_QUICK_START = 4
...
class Configuration(HttpClientConfiguration):
    ...
    def session_token_credentials(self):
        """Return current session_token_credentials."""
        return self._session_token_credentials

    @property
    def thingspace_oauth_1_credentials(self):
        """Return current thingspace_oauth_1_credentials."""
    ...
    def __init__(self, http_client_instance=None,
                 ...
                 environment=Environment.PRODUCTION, thingspace_oauth_credentials=None,
    ...
    def clone_with(self, http_client_instance=None,
        ...
        session_token_credentials =\
            (session_token_credentials
            or self.session_token_credentials)
        thingspace_oauth_1_credentials =\
            (thingspace_oauth_1_credentials
            or self.thingspace_oauth_1_credentials)
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        default_config = cls(
            ...
            session_token_credentials=SessionTokenCredentials.from_environment(),
            thingspace_oauth_1_credentials=ThingspaceOauth1Credentials.from_environment(),
        )
