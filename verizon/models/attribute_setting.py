...
class AttributeSetting(object):
    ...
    Describes an attribute being observed and the frequency with which the attribute
    is being observed.
    ...
    def from_dictionary(cls,
        ...
        is_observable =\
            ...
            if "isObservable" in dictionary.keys()\
                else APIHelper.SKIP
        is_observing =\
            dictionary.get("isObserving")\
            if "isObserving" in dictionary.keys()\
                else APIHelper.SKIP
        frequency =\
            NumericalData.from_dictionary(
                dictionary.get("frequency"))\
                if "frequency" in dictionary.keys()\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _is_observable=(
            self.is_observable
            if hasattr(self, "is_observable")
            else None
        )
        _is_observing=(
            self.is_observing
            if hasattr(self, "is_observing")
            else None
        )
        _frequency=(
            self.frequency
        ...
        return (
            ...
            f"is_observable={_is_observable!r}, "
            f"is_observing={_is_observing!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"is_observable={_is_observable!s}, "
            f"is_observing={_is_observing!s}, "
