...
class UploadAndScheduleFileResponse(object):
    ...
    Attributes:
        ...
        download_after_date (str): Specifies the starting date the client should
            download the package. If null, client downloads as soon as possible.
        download_time_window_list (List[DownloadTimeWindow]): List of allowed
            download time windows.
        install_after_date (str): The date after which you install the package. If
            null, install as soon as possible.
        install_time_window_list (List[DownloadTimeWindow]): List of allowed install
            time windows.
    ...
    def from_dictionary(cls,
        ...
        download_after_date =\
            ...
            if dictionary.get("downloadAfterDate")\
                else APIHelper.SKIP
        ...
        install_after_date =\
            ...
            if dictionary.get("installAfterDate")\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _software_from=(
            self.software_from
            if hasattr(self, "software_from")
            else None
        )
        _software_to=(
            self.software_to
            if hasattr(self, "software_to")
            else None
        )
        _file_name=(
            self.file_name
        ...
        return (
            ...
            f"file_version={_file_version!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"file_version={_file_version!s}, "
