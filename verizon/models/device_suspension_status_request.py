...
class DeviceSuspensionStatusRequest(object):
    ...
    Attributes:
        device_ids (List[DeviceId]): The devices that you want to include in the
            request, specified by device identifier. You only need to provide one
            identifier per device.
        filter (DeviceFilterWithoutAccount): Filter for devices without account.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("deviceIds") is not None:
            ...
            device_ids = APIHelper.SKIP
        filter =\
            DeviceFilterWithoutAccount.from_dictionary(
