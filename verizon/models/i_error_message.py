...
class IErrorMessage(object):
    ...
    Attributes:
        ...
        error_message (str): Details and additional information about the error code.
        http_status_code (HttpStatusCodeEnum): HTML error code and description.
        detail_error_message (str): More detail and information about the HTML error
            code.
    ...
    def from_dictionary(cls,
        ...
        http_status_code =\
            ...
            if dictionary.get("httpStatusCode")\
                else APIHelper.SKIP
        detail_error_message =\
            dictionary.get("detailErrorMessage")\
            if dictionary.get("detailErrorMessage")\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _detail_error_message=(
            self.detail_error_message
            if hasattr(self, "detail_error_message")
            else None
        )
        return (
            ...
            f"detail_error_message={_detail_error_message!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"detail_error_message={_detail_error_message!s}, "
            f")"
        )
