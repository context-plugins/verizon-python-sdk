...
class GeoFenceConfigurationUpdateRequest(SdkBaseModel):
    """Request for /api/v1/application/configurations/geofence PUT endpoint. It requires at least one of vendorId, name,
    description, geofence, messages and isActive fields to be populated."""
    ...
    geo_fence: Optional[GeoFence] = Field(default=UNSET, alias="geoFence")
    ...
    messages: Optional[list[Message]] = UNSET
...
class GeoFenceConfigurationUpdateRequestDict(TypedDict):
    name: NotRequired[str]
    description: NotRequired[str]
    geo_fence: NotRequired[GeoFence | GeoFenceDict]
    message_standard: NotRequired[MessageStandardOrStr]
    messages: NotRequired[list[Message | MessageDict]]
