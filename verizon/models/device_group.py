...
class DeviceGroup(object):
    ...
    Attributes:
        ...
        extended_attributes (List[CustomFields]): Any extended attributes for the
            device group, as Key and Value pairs.
    ...
    def from_dictionary(cls,
        ...
        is_default_group =\
            ...
            if "isDefaultGroup" in dictionary.keys()\
                else APIHelper.SKIP
        name =\
            dictionary.get("name")\
    ...
    def __repr__(self):
        ...
        _is_default_group=(
            ...
            if hasattr(self, "is_default_group")
            else None
        )
        _name=(
            self.name
        ...
        return (
            ...
            f"is_default_group={_is_default_group!r}, "
            f"name={_name!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"is_default_group={_is_default_group!s}, "
            f"name={_name!s}, "
            f")"
        )
