...
class AccountDeviceListRequest(object):
    ...
    Attributes:
        account_name (str): The billing account for which a list of devices is
            returned. If you don't specify an accountName, the list includes all
        ...
        current_state (str): The name of a device state, to only include devices in
            that state.
        ...
        earliest (str): Only include devices that were added after this date and time.
        group_name (str): Only include devices that are in this device group.
        latest (str): Only include devices that were added before this date and time.
    ...
    def from_dictionary(cls,
        ...
        max_number_of_devices =\
            ...
            if dictionary.get("maxNumberOfDevices")\
                else APIHelper.SKIP
        largest_device_id_seen =\
            dictionary.get("largestDeviceIdSeen")\
            if dictionary.get("largestDeviceIdSeen")\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _max_number_of_devices=(
            self.max_number_of_devices
            if hasattr(self, "max_number_of_devices")
            else None
        )
        _largest_device_id_seen=(
            self.largest_device_id_seen
            if hasattr(self, "largest_device_id_seen")
            else None
        )
        return (
            ...
            f"filter={_filter!r}, "
            f"current_state={_current_state!r}, "
            f"custom_fields={_custom_fields!r}, "
            f"earliest={_earliest!r}, "
            f"group_name={_group_name!r}, "
            f"latest={_latest!r}, "
            f"service_plan={_service_plan!r}, "
            f"max_number_of_devices={_max_number_of_devices!r}, "
            f"largest_device_id_seen={_largest_device_id_seen!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"filter={_filter!s}, "
            f"current_state={_current_state!s}, "
            f"custom_fields={_custom_fields!s}, "
            f"earliest={_earliest!s}, "
            f"group_name={_group_name!s}, "
            f"latest={_latest!s}, "
            f"service_plan={_service_plan!s}, "
            f"max_number_of_devices={_max_number_of_devices!s}, "
            f"largest_device_id_seen={_largest_device_id_seen!s}, "
            f")"
        )
