...
class FirmwareUpgrade(object):
    ...
    Attributes:
        ...
        firmware_name (str): The name of the firmware image that will be used for the
            upgrade.
        firmware_to (str): The name of the firmware version that will be on the
            devices after a successful upgrade.
        start_date (str): The intended start date for the upgrade.
        status (str): The current status of the upgrade.
        device_list (List[FirmwareUpgradeDeviceListItem]): A JSON object for each
            device that was included in the upgrade, showing the device IMEI, the
