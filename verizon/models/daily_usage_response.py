...
from verizon.models.daily_usage_history import (
    DailyUsageHistory,
)
...
class DailyUsageResponse(object):
    ...
    Attributes:
        has_more_data (bool): A flag set to indicate if there is more than one page
            of data returned by the query (true) or if only one page of data returned
            (false)
    ...
    def __init__(
        ...
        """Initialize a DailyUsageResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("usageHistory") is not None:
            usage_history = [
                DailyUsageHistory.from_dictionary(x)
