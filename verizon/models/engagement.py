...
class Engagement(object):
    ...
    Attributes:
        ...
        services (List[AccountService]): The services associated with the account.
    ...
    def from_dictionary(cls,
        ...
        engagement_id =\
            ...
            if dictionary.get("engagementId")\
                else APIHelper.SKIP
        charging_group =\
            dictionary.get("chargingGroup")\
            if dictionary.get("chargingGroup")\
                else APIHelper.SKIP
        services = None
    ...
    def __repr__(self):
        ...
        _charging_group=(
            self.charging_group
            if hasattr(self, "charging_group")
            else None
        )
        _services=(
            self.services
        ...
        return (
            ...
            f"engagement_id={_engagement_id!r}, "
            f"charging_group={_charging_group!r}, "
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"engagement_id={_engagement_id!s}, "
            f"charging_group={_charging_group!s}, "
