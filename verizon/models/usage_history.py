...
class UsageHistory(object):
    ...
    def __init__(
        ...
        if event_date_time is not APIHelper.SKIP:
            self.event_date_time =\
                ...
                event_date_time, APIHelper.RFC3339DateTime)\
                 if event_date_time else None
    ...
    def from_dictionary(cls,
        ...
        mo_sms =\
            ...
            if dictionary.get("moSMS")\
                else APIHelper.SKIP
        mt_sms =\
            dictionary.get("mtSMS")\
            if dictionary.get("mtSMS")\
                else APIHelper.SKIP
        source =\
    ...
    def __repr__(self):
        ...
        _mo_sms=(
            self.mo_sms
            if hasattr(self, "mo_sms")
            else None
        )
        _mt_sms=(
            self.mt_sms
            if hasattr(self, "mt_sms")
            else None
        )
        _source=(
            self.source
        ...
        _event_date_time=(
            self.event_date_time
            if hasattr(self, "event_date_time")
            else None
        )
        return (
            f"{self.__class__.__name__}("
            f"bytes_used={_bytes_used!r}, "
            f"serviceplan={_serviceplan!r}, "
            f"sms_used={_sms_used!r}, "
            f"mo_sms={_mo_sms!r}, "
            f"mt_sms={_mt_sms!r}, "
            f"source={_source!r}, "
            f"event_date_time={_event_date_time!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"serviceplan={_serviceplan!s}, "
            f"sms_used={_sms_used!s}, "
            f"mo_sms={_mo_sms!s}, "
            f"mt_sms={_mt_sms!s}, "
            f"source={_source!s}, "
            f"event_date_time={_event_date_time!s}, "
            f")"
        )
