...
class ProvisioningHistory(object):
    ...
    Attributes:
        occurred_at (str): The date and time when the provisioning event occured.
        ...
        msisdn (str): The MSISDN assigned to the device after the provisioning event.
        service_plan (str): The service plan of the device after the provisioning
            event occurred.
