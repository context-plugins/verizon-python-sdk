...
class AggregateUsage(object):
    ...
    Attributes:
        ...
        start_time (str): The start date of the time period queried as "$datetime"
        end_time (str): The end date of the time period being queried as "$datetime"
    ...
    def __init__(
        ...
        """Initialize a AggregateUsage instance."""
