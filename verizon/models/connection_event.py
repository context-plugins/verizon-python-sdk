...
class ConnectionEvent(object):
    ...
    def __repr__(self):
        ...
        _connection_event_attributes=(
            self.connection_event_attributes
            if hasattr(self, "connection_event_attributes")
            else None
        )
        ...
        return (
            ...
            f"connection_event_attributes={_connection_event_attributes!r}, "
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"connection_event_attributes={_connection_event_attributes!s}, "
