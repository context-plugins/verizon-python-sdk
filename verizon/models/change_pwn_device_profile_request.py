...
class ChangePWNDeviceProfileRequest(object):
    ...
    def __init__(
        ...
        device_list=None,
        new_profile=None):
        """Initialize a ChangePWNDeviceProfileRequest instance."""
