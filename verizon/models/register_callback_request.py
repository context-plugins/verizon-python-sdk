...
class RegisterCallbackRequest(object):
    ...
    Attributes:
        ...
        url (str): The address on your server where you have enabled a listening
            service for callback messages.
        username (str): The user name that the M2M Platform should return in the
            callback messages.
        password (str): The password that the M2M Platform should return in the
            callback messages.
