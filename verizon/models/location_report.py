...
class LocationReport(object):
    ...
    Attributes:
        ...
        has_more_data (bool): True if there are more device locations to retrieve.
        start_index (str): The zero-based number of the first record to return. Set
            startIndex=0 for the first request. If there are more than 1,000 devices
            to be returned (hasMoreData=true), set startIndex=1000 for the second
            request, 2000 for the third request, etc.
        total_count (int): The total number of devices in the original request and in
            the report.
    ...
    def __repr__(self):
        ...
        _dev_location_list=(
            self.dev_location_list
            if hasattr(self, "dev_location_list")
            else None
        )
        _has_more_data=(
            self.has_more_data
        ...
        return (
            ...
            f"dev_location_list={_dev_location_list!r}, "
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"dev_location_list={_dev_location_list!s}, "
