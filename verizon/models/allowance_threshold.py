...
class AllowanceThreshold(object):
    ...
    def __init__(
        ...
        """Initialize a AllowanceThreshold instance."""
    ...
    def from_dictionary(cls,
        ...
        percentage_50 =\
            dictionary.get("percentage50")\
            if "percentage50" in dictionary.keys()\
                else APIHelper.SKIP
        percentage_75 =\
            dictionary.get("percentage75")\
            if "percentage75" in dictionary.keys()\
                else APIHelper.SKIP
        percentage_90 =\
            dictionary.get("percentage90")\
            if "percentage90" in dictionary.keys()\
                else APIHelper.SKIP
        percentage_100 =\
            dictionary.get("percentage100")\
            if "percentage100" in dictionary.keys()\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _percentage_50=(
            self.percentage_50
            if hasattr(self, "percentage_50")
            else None
        )
        _percentage_75=(
            self.percentage_75
            if hasattr(self, "percentage_75")
            else None
        )
        _percentage_90=(
            self.percentage_90
            if hasattr(self, "percentage_90")
            else None
        )
        _percentage_100=(
            self.percentage_100
            if hasattr(self, "percentage_100")
            else None
        )
        return (
            f"{self.__class__.__name__}("
            f"percentage_50={_percentage_50!r}, "
            f"percentage_75={_percentage_75!r}, "
            f"percentage_90={_percentage_90!r}, "
            f"percentage_100={_percentage_100!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"percentage_50={_percentage_50!s}, "
            f"percentage_75={_percentage_75!s}, "
            f"percentage_90={_percentage_90!s}, "
            f"percentage_100={_percentage_100!s}, "
            f")"
        )
