...
class RatePlanGroup(object):
    ...
    def __init__(
        ...
        """Initialize a RatePlanGroup instance."""
    ...
    def from_dictionary(cls,
        ...
        carrier_rate_plan_code =\
            dictionary.get("carrierRatePlanCode")\
            if dictionary.get("carrierRatePlanCode")\
                else APIHelper.SKIP
        zero_dollar_billing =\
            dictionary.get("zeroDollarBilling")\
            if "zeroDollarBilling" in dictionary.keys()\
                else APIHelper.SKIP
        promotion_offered =\
            dictionary.get("promotionOffered")\
            if "promotionOffered" in dictionary.keys()\
                else APIHelper.SKIP
        promotion_days =\
            dictionary.get("promotionDays")\
            if dictionary.get("promotionDays")\
                else APIHelper.SKIP
        account = None
        if dictionary.get("account") is not None:
            account = [
                Accountid.from_dictionary(x)
    ...
    def __repr__(self):
        ...
        _carrier_rate_plan_code=(
            self.carrier_rate_plan_code
            if hasattr(self, "carrier_rate_plan_code")
            else None
        )
        _zero_dollar_billing=(
            self.zero_dollar_billing
            if hasattr(self, "zero_dollar_billing")
            else None
        )
        _promotion_offered=(
            self.promotion_offered
            if hasattr(self, "promotion_offered")
            else None
        )
        _promotion_days=(
            self.promotion_days
            if hasattr(self, "promotion_days")
            else None
        )
        _account=(
            self.account
        ...
        return (
            ...
            f"carrier_rate_plan_code={_carrier_rate_plan_code!r}, "
            f"zero_dollar_billing={_zero_dollar_billing!r}, "
            f"promotion_offered={_promotion_offered!r}, "
            f"promotion_days={_promotion_days!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"carrier_rate_plan_code={_carrier_rate_plan_code!s}, "
            f"zero_dollar_billing={_zero_dollar_billing!s}, "
            f"promotion_offered={_promotion_offered!s}, "
            f"promotion_days={_promotion_days!s}, "
