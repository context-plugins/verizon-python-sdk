...
class DevicesConsentResult(object):
    ...
    def from_dictionary(cls,
        ...
        all_device =\
            ...
            if "allDevice" in dictionary.keys()\
                else APIHelper.SKIP
        has_more_data =\
