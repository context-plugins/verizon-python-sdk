...
class SearchDeviceResponse(object):
    ...
    A success response includes an array of all matching events. Each event includes
    the full event resource definition.
    ...
    Attributes:
        ...
        tagids (List[str]): UUIDs of tag resources that are applied to this device.
