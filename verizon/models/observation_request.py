...
class ObservationRequest(object):
    ...
    corresponding attribute values and the date/timestamp of when the observation was
    made.

    Attributes:
        account_name (str): Account identifier in "##########-#####".
        devices (List[Device]): List of devices.
        attributes (List[ObservationRequestAttribute]): Attributes are streaming RF
            parameters that you want to observe.
