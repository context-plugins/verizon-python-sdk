...
class DeviceAggregateUsageListRequest(object):
    ...
    Attributes:
        start_time (str): The beginning of the reporting period. The startTime cannot
            be more than 6 months before the current date.
        end_time (str): The end of the reporting period. The endTime date must be
            within on month of the startTime date.
        device_ids (List[DeviceId]): One or more devices for which you want aggregate
            data, specified by device ID.
