...
class CarrierDeactivateRequest(object):
    ...
    Attributes:
        ...
        etf_waiver (bool): Fees may be assessed for deactivating Verizon Wireless
            devices, depending on the account contract. The etfWaiver parameter
            waives the Early Termination Fee (ETF), if applicable.
        group_name (str): The name of a device group, if you want to deactivate all
    ...
    def from_dictionary(cls,
        ...
        etf_waiver =\
            ...
            if "etfWaiver" in dictionary.keys()\
                else APIHelper.SKIP
        group_name =\
        ...
        delete_after_deactivation =\
            ...
            if "deleteAfterDeactivation" in dictionary.keys()\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _delete_after_deactivation=(
            self.delete_after_deactivation
            if hasattr(self, "delete_after_deactivation")
            else None
        )
        return (
            ...
            f"etf_waiver={_etf_waiver!r}, "
            f"group_name={_group_name!r}, "
            f"service_plan={_service_plan!r}, "
            f"delete_after_deactivation={_delete_after_deactivation!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"etf_waiver={_etf_waiver!s}, "
            f"group_name={_group_name!s}, "
            f"service_plan={_service_plan!s}, "
            f"delete_after_deactivation={_delete_after_deactivation!s}, "
            f")"
        )
