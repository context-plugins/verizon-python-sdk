...
class Usage(object):
    ...
    Attributes:
        bytes_used (int): The number of bytes that the device sent or received on the
            report date.
        extended_attributes (List[CustomFields]): The number of mobile-originated and
            mobile-terminated SMS messages on the report date.
        service_plan (str): The list of service plans associated with the
            device/account.
        sms_used (int): The number of SMS messages that were sent or received on the
            report date.
