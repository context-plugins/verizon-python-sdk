...
class AsynchronousLocationRequestResult(object):
    ...
    Attributes:
        ...
        estimated_duration (str): Estimated number of minutes required to complete
            the report.
    ...
    def from_dictionary(cls,
        ...
        estimated_duration =\
            ...
            if dictionary.get("estimatedDuration")\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _estimated_duration=(
            ...
            if hasattr(self, "estimated_duration")
            else None
        )
        return (
            ...
            f"txid={_txid!r}, "
            f"status={_status!r}, "
            f"estimated_duration={_estimated_duration!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"txid={_txid!s}, "
            f"status={_status!s}, "
            f"estimated_duration={_estimated_duration!s}, "
            f")"
        )
