...
class CreateTargetRequest(object):
    ...
    Attributes:
        ...
        address (str): The endpoint for notifications or data streams. The format
            depends on the selected `addressscheme`.<br />`streamrest` requires a
            `host:port` value <br />`streamawsiot` requres a valid ARN.
        ...
        oauth (TargetAuthentication): OAuth 2 token and refresh token for TS to
    ...
    def from_dictionary(cls,
        ...
        fields =\
            CreateTargetRequestFields.from_dictionary(
        ...
        oauth =\
            TargetAuthentication.from_dictionary(
                dictionary.get("oauth"))\
                if "oauth" in dictionary.keys()\
                else APIHelper.SKIP
