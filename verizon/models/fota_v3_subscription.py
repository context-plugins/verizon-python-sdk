...
class FotaV3Subscription(object):
    ...
    Attributes:
        ...
        license_used_count (int): Number of licenses currently assigned to devices.
    ...
    def from_dictionary(cls,
        ...
        purchase_type =\
            ...
            if dictionary.get("purchaseType")\
                else APIHelper.SKIP
        license_count =\
            dictionary.get("licenseCount")\
            if dictionary.get("licenseCount")\
                else APIHelper.SKIP
        license_used_count =\
            dictionary.get("licenseUsedCount")\
            if dictionary.get("licenseUsedCount")\
                else APIHelper.SKIP
        update_time =\
    ...
    def __repr__(self):
        ...
        _license_used_count=(
            self.license_used_count
            if hasattr(self, "license_used_count")
            else None
        )
        _update_time=(
            self.update_time
        ...
        return (
            ...
            f"license_count={_license_count!r}, "
            f"license_used_count={_license_used_count!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"license_count={_license_count!s}, "
            f"license_used_count={_license_used_count!s}, "
