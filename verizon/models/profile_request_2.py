...
class ProfileRequest2(object):
    ...
    Attributes:
        devices (List[DeviceList2]): The model property of type List[DeviceList2].
    ...
    def from_dictionary(cls,
        ...
        etf_waiver =\
            ...
            if dictionary.get("etfWaiver")\
                else True
        check_fallback_profile =\
            dictionary.get("checkFallbackProfile")\
            if dictionary.get("checkFallbackProfile")\
                else False
    ...
    def __repr__(self):
        ...
        _check_fallback_profile=(
            self.check_fallback_profile
            if hasattr(self, "check_fallback_profile")
            else None
        )
        return (
            ...
            f"check_fallback_profile={_check_fallback_profile!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"check_fallback_profile={_check_fallback_profile!s}, "
            f")"
        )
