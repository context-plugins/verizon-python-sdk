...
class TriggerNotification(object):
    ...
    Attributes:
        ...
        email_notification (bool): Whether or not the notification should be sent via
            e-mail.<br />true<br />false.
        ...
        notification_frequency_interval (str): Frequency interval for notification.
        external_email_recipients (str): E-mail address(es) where the notification
            should be delivered.
        ...
        severity (str): Severity level associated with the notification. Examples
            would be:<br />Major<br />Minor<br />Critical<br />NotApplicable.
