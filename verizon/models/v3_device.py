...
class V3Device(object):
    ...
    Attributes:
        ...
        fota_eligible (bool): Value=true if the device software can be upgraded over
            the air using the Software Management Services API.
        status (str): Device status.
        license_assigned (bool): License assigned device.
        protocol (str): Firmware protocol. Valid values include: LWM2M, OMADM, HTTP
            or NONE.
        ...
        status_time (str): The date and time of when the device firmware or software
            is updated.
    ...
    def __init__(
        ...
        if last_connection_time is not APIHelper.SKIP:
            self.last_connection_time =\
                ...
                last_connection_time, APIHelper.RFC3339DateTime)\
                 if last_connection_time else None
    ...
    def from_dictionary(cls,
        ...
        request_status =\
            ...
            if dictionary.get("requestStatus")\
                else APIHelper.SKIP
        result_reason =\
            dictionary.get("resultReason")\
            if dictionary.get("resultReason")\
                else APIHelper.SKIP
        mdn =\
            dictionary.get("mdn")\
        ...
        firmware =\
            ...
            if dictionary.get("firmware")\
                else APIHelper.SKIP
        fota_eligible =\
            dictionary.get("fotaEligible")\
            if "fotaEligible" in dictionary.keys()\
                else APIHelper.SKIP
        status =\
        ...
        license_assigned =\
            ...
            if "licenseAssigned" in dictionary.keys()\
                else APIHelper.SKIP
        protocol =\
        ...
        create_time =\
            ...
            if dictionary.get("createTime")\
                else APIHelper.SKIP
        status_time =\
            dictionary.get("statusTime")\
            if dictionary.get("statusTime")\
                else APIHelper.SKIP
        update_time =\
            dictionary.get("updateTime")\
            if dictionary.get("updateTime")\
                else APIHelper.SKIP
        refresh_time =\
            dictionary.get("refreshTime")\
            if dictionary.get("refreshTime")\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _request_status=(
            self.request_status
            if hasattr(self, "request_status")
            else None
        )
        _result_reason=(
            self.result_reason
            if hasattr(self, "result_reason")
            else None
        )
        _mdn=(
            self.mdn
        ...
        _license_assigned=(
            self.license_assigned
            if hasattr(self, "license_assigned")
            else None
        )
        _protocol=(
            self.protocol
        ...
        return (
            ...
            f"request_status={_request_status!r}, "
            f"result_reason={_result_reason!r}, "
            f"mdn={_mdn!r}, "
            f"model={_model!r}, "
            f"make={_make!r}, "
            f"firmware={_firmware!r}, "
            f"fota_eligible={_fota_eligible!r}, "
            f"status={_status!r}, "
            f"license_assigned={_license_assigned!r}, "
            f"protocol={_protocol!r}, "
            f"software_list={_software_list!r}, "
            f"file_list={_file_list!r}, "
            f"create_time={_create_time!r}, "
            f"status_time={_status_time!r}, "
            f"update_time={_update_time!r}, "
            f"refresh_time={_refresh_time!r}, "
            f"last_connection_time={_last_connection_time!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"request_status={_request_status!s}, "
            f"result_reason={_result_reason!s}, "
            f"mdn={_mdn!s}, "
            f"model={_model!s}, "
            f"make={_make!s}, "
            f"firmware={_firmware!s}, "
            f"fota_eligible={_fota_eligible!s}, "
            f"status={_status!s}, "
            f"license_assigned={_license_assigned!s}, "
            f"protocol={_protocol!s}, "
            f"software_list={_software_list!s}, "
            f"file_list={_file_list!s}, "
            f"create_time={_create_time!s}, "
            f"status_time={_status_time!s}, "
            f"update_time={_update_time!s}, "
            f"refresh_time={_refresh_time!s}, "
            f"last_connection_time={_last_connection_time!s}, "
            f")"
        )
