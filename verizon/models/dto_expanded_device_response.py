...
class DtoExpandedDeviceResponse(SdkBaseModel):
    ...
    commands: Optional[dict[str, Any]] = UNSET
    ...
    modelmetadata: Optional[Any] = UNSET
    """Detail"""
