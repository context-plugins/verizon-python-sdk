...
class FlowInfo(object):
    ...
    def from_dictionary(cls,
        ...
        flow_server =\
            ...
            if dictionary.get("flowServer")\
                else APIHelper.SKIP
        flow_device =\
            dictionary.get("flowDevice")\
            if dictionary.get("flowDevice")\
                else APIHelper.SKIP
        flow_direction =\
            dictionary.get("flowDirection")\
            if dictionary.get("flowDirection")\
                else APIHelper.SKIP
        flow_protocol =\
            dictionary.get("flowProtocol")\
            if dictionary.get("flowProtocol")\
                else APIHelper.SKIP
        qci_option =\
            dictionary.get("qciOption")\
            if dictionary.get("qciOption")\
                else APIHelper.SKIP
    ...
    def __repr__(self):
        ...
        _flow_server=(
            self.flow_server
            if hasattr(self, "flow_server")
            else None
        )
        _flow_device=(
            self.flow_device
            if hasattr(self, "flow_device")
            else None
        )
        _flow_direction=(
            self.flow_direction
        ...
        _flow_protocol=(
            self.flow_protocol
            if hasattr(self, "flow_protocol")
            else None
        )
        _qci_option=(
            self.qci_option
            if hasattr(self, "qci_option")
            else None
        )
        return (
            f"{self.__class__.__name__}("
            f"flow_server={_flow_server!r}, "
            f"flow_device={_flow_device!r}, "
            f"flow_direction={_flow_direction!r}, "
            f"flow_protocol={_flow_protocol!r}, "
            f"qci_option={_qci_option!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"flow_server={_flow_server!s}, "
            f"flow_device={_flow_device!s}, "
            f"flow_direction={_flow_direction!s}, "
            f"flow_protocol={_flow_protocol!s}, "
            f"qci_option={_qci_option!s}, "
            f")"
        )
