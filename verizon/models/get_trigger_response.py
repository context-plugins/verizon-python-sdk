...
class GetTriggerResponse(object):
    ...
    def from_dictionary(cls,
        ...
        trigger_cycle =\
            ...
            if dictionary.get("triggerCycle")\
                else APIHelper.SKIP
        trigger_id =\
