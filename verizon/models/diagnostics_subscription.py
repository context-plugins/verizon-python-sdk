...
class DiagnosticsSubscription(object):
    ...
    Attributes:
        account_name (str): Account identifier in "##########-#####". An account name
            is usually numeric, and must include any leading zeros.
        created_on (datetime): The date and time of when the subscription was created.
        last_updated (datetime): The date and time of when the subscription was last
            updated.
    ...
    def from_dictionary(cls,
        ...
        total_allowed =\
            ...
            if dictionary.get("totalAllowed")\
                else None
        total_used =\
            dictionary.get("totalUsed")\
            if dictionary.get("totalUsed")\
                else None
        sku_name =\
    ...
    def __repr__(self):
        ...
        _total_allowed=self.total_allowed
        _total_used=self.total_used
        _sku_name=self.sku_name
        return (
            f"{self.__class__.__name__}("
            f"account_name={_account_name!r}, "
            f"created_on={_created_on!r}, "
            f"last_updated={_last_updated!r}, "
            f"total_allowed={_total_allowed!r}, "
            f"total_used={_total_used!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"total_allowed={_total_allowed!s}, "
            f"total_used={_total_used!s}, "
