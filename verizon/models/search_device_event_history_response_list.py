...
class SearchDeviceEventHistoryResponseList(object):
    ...
    Attributes:
        search_device_event_history (List[SearchDeviceResponse]): The model property
    ...
    def __repr__(self):
        ...
        _search_device_event_history=(
            self.search_device_event_history
            if hasattr(self, "search_device_event_history")
            else None
        )
        return (
            f"{self.__class__.__name__}("
            f"search_device_event_history={_search_device_event_history!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"search_device_event_history={_search_device_event_history!s}, "
            f")"
        )
