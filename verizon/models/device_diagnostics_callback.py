...
class DeviceDiagnosticsCallback(object):
    ...
    Attributes:
        ...
        service_name (str): The name of the callback service, which identifies the
            type and format of messages that will be sent to the registered URL.
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"http_headers={_http_headers!r}, "
            f")"
        )
    ...
    def __str__(self):
        ...
        return (
            ...
            f"http_headers={_http_headers!s}, "
            f")"
        )
