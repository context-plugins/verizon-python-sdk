...
class DeviceSMSMessagingController(BaseController):
    ...
    def send_an_sms_message(self,
        ...
        Platform and sent as soon as possible, but they may be delayed due to traffic
    ...
    def get_sms_messages(self,
        ...
        Retrieves queued SMS messages sent by all M2M MC devices associated with an
        account.

        Args:
            account_name (str): Numeric account name
            next (str, optional): Continue the previous query from the pageUrl in
                Location Header
    ...
    def start_sms_message_delivery(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Request Success Message
