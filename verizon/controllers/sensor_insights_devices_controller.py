...
from verizon.exceptions.m_400_management_error_exception import (
    M400ManagementErrorException,
)
from verizon.exceptions.m_403_management_error_exception import (
    M403ManagementErrorException,
)
from verizon.exceptions.m_404_management_error_exception import (
    M404ManagementErrorException,
)
from verizon.exceptions.m_500_management_error_exception import (
    M500ManagementErrorException,
)
from verizon.exceptions.management_error_exception import (
    ManagementErrorException,
)
from verizon.http.http_method_enum import HttpMethodEnum
from verizon.models.dto_device_action_set_response import (
    DtoDeviceActionSetResponse,
)
from verizon.models.dto_expanded_device_response import (
    DtoExpandedDeviceResponse,
)
from verizon.models.dto_last_reported_time_response import (
    DtoLastReportedTimeResponse,
)
from verizon.models.resource_device import ResourceDevice
from verizon.models.user_device_experience_history import (
    UserDeviceExperienceHistory,
)
from verizon.models.user_network_experience_history import (
...
class SensorInsightsDevicesController(BaseController):
    ...
    def sensor_insights_patch_device_request(self,
                                             body):
        """Perform a PATCH request to /dm/v1/devices.
    ...
    def sensor_insights_last_reported_time_request(self,
                                                   body):
        """Perform a POST request to /dm/v1/devices/lastreported.

        Args:
            body (DtoLastReportedTimeRequest): Get the last reported information for
                a device
    ...
    def sensor_insights_device_action_set_request(self,
                                                  body):
        """Perform a POST request to /dm/v1/devices/actions/set.
        ...
        return super().new_api_call_builder.request(
            ...
            .body_param(Parameter()
                ...
                .validator(lambda value: UnionTypeLookUp
                    .get("SensorInsightsDeviceActionSetRequestBody").validate(value)))
            .header_param(Parameter()
                .key("accept")
                .value("application/json"))
            .body_serializer(APIHelper.json_serialize)
    ...
    def sensor_insights_list_device_experience_history_request(self,
                                                               body):
        """Perform a POST request to /dm/v1/devices/experience/actions/query.

        Args:
            body (DtoListDeviceExperienceHistoryRequest): List the device experience
    ...
    def sensor_insights_list_network_experience_history_request(self,
        ...
        Args:
            body (DtoListNetworkExperienceHistoryRequest): List the network experience
