...
class SoftwareManagementReportsV2Controller(BaseController):
    ...
    def list_available_software(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Return array of
                software.
    ...
    def list_account_devices(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Return array of devices.
    ...
    def get_device_firmware_upgrade_history(self,
        ...
        The endpoint allows user to get software upgrade history of a device based on
        device IMEI.
    ...
    def get_campaign_history_by_status(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Return list of campaign
                history.
