...
class ClientLoggingController(BaseController):
    ...
    def list_devices_with_logging_enabled(self,
        ...
        Returns an array of all devices in the specified account for which logging is
        enabled.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List containing device
    ...
    def enable_device_logging(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Device logging status
                information.
    ...
    def list_device_logs(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of device logs.
