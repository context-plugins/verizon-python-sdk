...
class FirmwareV1Controller(BaseController):
    ...
    def list_available_firmware(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of available
                firmware.
    ...
    def schedule_firmware_upgrade(self,
        ...
        Args:
            body (FirmwareUpgradeRequest): Details of the firmware upgrade request.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Confirmation of
    ...
    def list_firmware_upgrade_details(self,
        ...
        Returns information about a specified upgrade, include the target date of the
        upgrade, the list of devices in the upgrade, and the status of the upgrade
        for each device.

        Args:
            account_name (str): Account identifier in "##########-#####".
            upgrade_id (str): The UUID of the upgrade, returned by POST /upgrades
                when the upgrade was scheduled.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Firmware upgrade
                information.
    ...
    def update_firmware_upgrade_devices(self,
        ...
        Args:
            ...
            upgrade_id (str): The UUID of the upgrade, returned by POST /upgrades
                when the upgrade was scheduled.
            body (FirmwareUpgradeChangeRequest): List of devices to add or remove.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Upgrade information.
    ...
    def cancel_scheduled_firmware_upgrade(self,
        ...
        Args:
            account_name (str): Account identifier in "##########-#####".
            upgrade_id (str): The UUID of the scheduled upgrade that you want to
                cancel.
