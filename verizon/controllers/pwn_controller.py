...
from verizon.models.change_pwn_device_ipaddress_response import (
    ChangePWNDeviceIpaddressResponse,
)
from verizon.models.change_pwn_device_profile_response import (
    ChangePWNDeviceProfileResponse,
)
from verizon.models.change_pwn_device_state_response import (
    ChangePWNDeviceStateResponse,
)
from verizon.models.get_pwn_performance_consent_response import (
    GetPWNPerformanceConsentResponse,
)
from verizon.models.kpi_info_list import KPIInfoList
from verizon.models.pwn_profile_list import (
    PWNProfileList,
)
...
class PWNController(BaseController):
    ...
    def __init__(self, config):
        """Initialize PWNController object."""
        super(PWNController, self).__init__(config)

    def kpi_list(self,
                 aname):
        """Perform a GET request to /m2m/v1/devices/pwn/kpi/list/{aname}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Kpi list received on a
                successful response.
    ...
    def get_profile_list(self,
                         aname):
        """Perform a GET request to /m2m/v1/devices/pwn/profiles/list/{aname}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. PWN profiles list
    ...
    def change_pwn_device_state_activate(self,
        ...
        Args:
            body (ChangePWNDeviceStateActivateRequest): The request body parameter.
    ...
    def change_pwn_device_state_deactivate(self,
        ...
        Args:
            body (ChangePWNDeviceStateDeactivateRequest): The request body parameter.
    ...
    def change_pwn_device_profile(self,
                                  body):
        """Perform a POST request to /m2m/v1/devices/pwn/actions/profile.
    ...
    def change_pwn_device_ipaddress(self,
                                    body):
        """Perform a PUT request to /m2m/v1/devices/pwn/actions/ipaddress.
    ...
    def get_pwn_performance_consent(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. consent received on a
                successful response.
