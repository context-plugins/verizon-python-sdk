...
from verizon.models.dto_notification_group_response_entity import (
...
class SensorInsightsNotificationGroupsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize SensorInsightsNotificationGroupsController object."""
    ...
    def sensor_insights_list_notification_group_request(self,
                                                        body):
        """Perform a POST request to /dm/v1/notificationGroups/actions/query.

        Args:
            body (DtoListNotificationGroupRequest): Retrieve a notification group
    ...
    def sensor_insights_update_notification_group_request(self,
                                                          body):
        """Perform a PATCH request to /dm/v1/notificationGroups.

        Args:
            body (DtoUpdateNotificationGroupRequest): Partially update a notification
                group
    ...
    def sensor_insights_create_notification_group_request(self,
                                                          body):
        """Perform a POST request to /dm/v1/notificationGroups.

        Args:
            body (DtoCreateNotificationGroupRequest): Create a notification group
    ...
    def sensor_insights_delete_notification_group(self,
                                                  payload):
        """Perform a DELETE request to /dm/v1/notificationGroups.

        Args:
            payload (DtoDeleteNotificationGroupRequest): Payload for the delete
                request.
    ...
    def sensor_insights_add_users_to_notification_group_request(self,
        ...
        Args:
            body (DtoAddUsersToNotificationGroupRequest): Add users to a notification
                group
    ...
    def sensor_insights_remove_users_from_notification_group_request(self,
        ...
        Args:
            body (DtoRemoveUsersFromNotificationGroupRequest): Remove users from a
                notification group
