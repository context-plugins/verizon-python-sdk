...
class CloudConnectorDevicesController(BaseController):
    ...
    def update_devices_configuration_value(self,
        ...
        Change configuration values on a device, such as setting how often a device
        records and reports sensor readings.

        Args:
            body (ChangeConfigurationRequest): The request body changes configuration
                values on a device.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. A success response
                contains the ts.event.configuration event that was created to record
                the change.
    ...
    def find_device_by_property_values(self,
        ...
        Args:
            body (QuerySubscriptionRequest): The request body specifies fields and
                values to match.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. A success response
                includes an array of all matching devices. Each device includes the
    ...
    def search_devices_resources_by_property_values(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. A success response
                includes an array of all matching devices.
    ...
    def search_device_event_history(self,
        ...
        Args:
            body (SearchDeviceEventHistoryRequest): The device identifier and fields
    ...
    def search_sensor_readings(self,
        ...
        first. Sensor readings are stored as events; this request an array of events.

        Args:
            fieldname (str): The name of the sensor.
            body (SearchSensorHistoryRequest): The device identifier and fields to
                match in the search.
    ...
    def delete_device_from_account(self,
        ...
        Args:
            body (RemoveDeviceRequest): The request body identifies the device to
                delete.
