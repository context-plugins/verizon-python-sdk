...
class DeviceManagementController(BaseController):
    ...
    def activate_service_for_devices(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Request ID received on
    ...
    def update_devices_contact_information(self,
        ...
        Sends a CarrierService callback message for each device in the request when
        the contact information has been changed, or if there was a problem and the
        change could not be completed.

        Args:
            body (ContactInfoUpdateRequest): Request to update contact information
                for devices.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Request ID returned in
                a success response.
    ...
    def update_devices_custom_fields(self,
        ...
        Sends a CarrierService callback message for each device in the request when
        the custom fields have been changed, or if there was a problem and the change
        could not be completed.

        Args:
            body (CustomFieldsUpdateRequest): Request to update custom field of
                devices.
    ...
    def deactivate_service_for_devices(self,
        ...
        with Verizon. If your contract allows ETF waivers and if you want to use one
        for a particular deactivation, set the etfWaiver value to True.

        Args:
            body (CarrierDeactivateRequest): Request to deactivate service for one or
                more devices.
    ...
    def list_devices_information(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of devices that
                match the request parameters, ordered by device creation date, oldest
                first.
    ...
    def list_devices_with_imei_iccid_mismatch(self,
        ...
        Returns a list of all 4G devices with an ICCID (SIM) that was not activated
        with the expected IMEI (hardware) during a specified time frame.

        Args:
            body (DeviceMismatchListRequest): Request to list devices with mismatched
                IMEIs and ICCIDs.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of devices that
                have mismatched IMEIs and ICCIDs.
    ...
    def update_devices_state(self,
        ...
        Args:
            body (GoToStateRequest): Request to change device state to one defined by
                the user.
    ...
    def change_devices_service_plan(self,
        ...
        Args:
            body (ServicePlanUpdateRequest): Request to change device service plan.
    ...
    def suspend_service_for_devices(self,
        ...
        Args:
            body (CarrierActionsRequest): Request to suspend service for one or more
                devices.
    ...
    def restore_service_for_suspended_devices(self,
        ...
        Args:
            body (CarrierActionsRequest): Request to restore services of one or more
                suspended devices.
    ...
    def check_devices_availability_for_activation(self,
        ...
        Checks whether specified devices are registered by the manufacturer with the
        Verizon network and are available to be activated.
    ...
    def retrieve_device_connection_history(self,
        ...
        Each response includes a maximum of 500 records. To obtain more records, you
        can call the API multiple times, adjusting the earliest value each time to
        start where the previous request finished.

        Args:
            body (DeviceConnectionListRequest): Query to retrieve device connection
                history.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of device
                connection events, sorted by the occurredAt timestamp, oldest first.
    ...
    def update_devices_cost_center_code(self,
        ...
        Args:
            body (DeviceCostCenterRequest): Request to update cost center code value
    ...
    def get_device_extended_diagnostic_information(self,
        ...
        Returns extended diagnostic information about a specified device, including
        connectivity, provisioning, billing and location status.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Device diagnostic
                information.
    ...
    def list_devices_provisioning_history(self,
        ...
        Args:
            body (DeviceProvisioningHistoryListRequest): Query to obtain device
                provisioning history.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of Device
                Provision History events, sorted by the timestamp, oldest first.
    ...
    def get_device_service_suspension_status(self,
        ...
        device state and information on how many days a device has been suspended and
    ...
    def list_devices_usage_history(self,
        ...
        Args:
            body (DeviceUsageListRequest): Request to obtain usage history for a
                specific device.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of device usage
    ...
    def retrieve_aggregate_device_usage_history(self,
        ...
        Args:
            body (DeviceAggregateUsageListRequest): A request to retrieve aggregated
                device usage history information.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. A unique string that
                associates the request with the results that are sent via a callback
                service.
    ...
    def device_upload(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Request ID
    ...
    def billed_usage_info(self,
        ...
        Args:
            body (BilledusageListRequest): Request to list devices with mismatched
                IMEIs and ICCIDs.
    ...
    def usage_segmentation_label_association(self,
        ...
        Args:
            body (AssociateLabelRequest): Request to associate a label to a device.
    ...
    def usage_segmentation_label_deletion(self,
        ...
        Args:
            ...
            label_list (LabelsList): A list of the Label IDs to remove from the
                exclusion list.
    ...
    def upload_activate_device(self,
        ...
        Uploads and activates device identifiers and SKUs for new devices from OEMs
        to Verizon.

        Args:
            body (UploadsActivatesDeviceRequest): Request to Upload and Activate
                device.
    ...
    def device_upload_status(self,
        ...
        Checks the status of an activation order and lists where the order is in the
        provisioning process.

        Args:
            body (CheckOrderStatusRequest): The request body identifies the device
                and reporting period that you want included in the report.
