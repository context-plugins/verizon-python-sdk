...
class DeviceGroupsController(BaseController):
    ...
    def create_device_group(self,
        ...
        Args:
            body (CreateDeviceGroupRequest): A request to create a new device group.
    ...
    def list_device_groups(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. The list of device
    ...
    def get_device_group_information(self,
        ...
        form /groups/{aname}/name/{gname}/?next={token}. This URL can be used to
        request the next set of groups.
