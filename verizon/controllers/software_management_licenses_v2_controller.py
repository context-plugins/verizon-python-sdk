...
class SoftwareManagementLicensesV2Controller(BaseController):
    ...
    def get_account_license_status(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Summary of license
                assignment.
    ...
    def assign_licenses_to_devices(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. License assignment
                result.
    ...
    def remove_licenses_from_devices(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. License removal result.
    ...
    def list_licenses_to_remove(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. A list of license
                cancellation candidate devices.
    ...
    def create_list_of_licenses_to_remove(self,
        ...
        Args:
            account (str): Account identifier.
            body (V2ListOfLicensesToRemoveRequest): List of licensess to remove.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Return a created
    ...
    def delete_list_of_licenses_to_remove(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Result of deletion of
                candidate list of devices to remove.
