...
class CampaignsV3Controller(BaseController):
    ...
    def schedule_campaign_firmware_upgrade(self,
                                           account_name,
                                           body):
        """Perform a POST request to /campaigns/firmware/{accountName}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Return upgrade
                information.
    ...
    def update_campaign_firmware_devices(self,
        ...
        Args:
            ...
            body (V3AddOrRemoveDeviceRequest): Add or remove device to existing
                upgrade information.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns add or remove
                devices to existing upgrade information.
    ...
    def update_campaign_dates(self,
        ...
        This endpoint allows user to change campaign dates and time windows. Fields
        which need to remain unchanged should be also provided.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Updated campaign
                information.
    ...
    def get_campaign_information(self,
                                 account_name,
                                 campaign_id):
        """Perform a GET request to /campaigns/{accountName}/{campaignId}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns firmware
                upgrade information.
    ...
    def cancel_campaign(self,
                        account_name,
                        campaign_id):
        """Perform a DELETE request to /campaigns/{accountName}/{campaignId}.

        This endpoint allows user to cancel a firmware campaign. A firmware campaign
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns cancellation
                status.
