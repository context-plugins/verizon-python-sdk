...
class DiagnosticsCallbacksController(BaseController):
    ...
    def get_diagnostics_subscription_callback_info(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns callback
                registration.
    ...
    def register_diagnostics_callback_url(self,
        ...
        Args:
            body (CallbackRegistrationRequest): Callback URL registration request.
    ...
    def unregister_diagnostics_callback(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Device diagnostics
