...
class FirmwareV3Controller(BaseController):
    ...
    def list_available_firmware(self,
        ...
        Args:
            ...
            protocol (FirmwareProtocolEnum): Filter to retrieve a specific protocol
                type used.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns an array of
                firmware objects.
    ...
    def synchronize_device_firmware(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns device firmware
                information.
    ...
    def report_device_firmware(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Device firmware version
                update request.
