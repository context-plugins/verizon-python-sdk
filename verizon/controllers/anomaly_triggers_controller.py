...
class AnomalyTriggersController(BaseController):
    ...
    def list_anomaly_detection_triggers(self):
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of triggers
    ...
    def update_anomaly_detection_trigger(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Trigger ID
    ...
    def list_anomaly_detection_trigger_settings(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Trigger information
                associated to a Trigger Id
    ...
    def delete_anomaly_detection_trigger(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. The ID of the deleted
                trigger is returned
