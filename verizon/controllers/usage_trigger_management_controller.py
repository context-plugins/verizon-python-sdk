...
class UsageTriggerManagementController(BaseController):
    ...
    def create_new_trigger(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Usage trigger Add result
    ...
    def update_trigger(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Usage trigger Modify
                result
    ...
    def delete_trigger(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Delete result
