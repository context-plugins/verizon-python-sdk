...
class DevicesLocationsController(BaseController):
    ...
    def list_devices_locations_asynchronous(self,
        ...
        Args:
            body (LocationRequest): An asynchronous request to obtain locations of
                devices.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Request accepted;
    ...
    def retrieve_location_report(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Location information
                for up to 1,000 devices.
    ...
    def get_location_report_status(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Location report status.
    ...
    def cancel_queued_location_report_generation(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Report generation
                cancelled.
