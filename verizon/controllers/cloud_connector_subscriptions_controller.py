...
class CloudConnectorSubscriptionsController(BaseController):
    ...
    def create_subscription(self,
        ...
        Args:
            body (CreateSubscriptionRequest): The request body provides the details
                of the subscription that you want to create.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns full
    ...
    def query_subscription(self,
        ...
        Search for subscriptions by property values. Returns an array of all matching
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns an array of all
    ...
    def delete_subscription(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Subscription deleted
                successfully.
