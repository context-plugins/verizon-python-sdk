...
class SoftwareManagementCallbacksV1Controller(BaseController):
    ...
    def list_registered_callbacks(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of callbacks.
    ...
    def register_callback(self,
        ...
        Registers a URL to receive RESTful messages from a callback service when new
        firmware versions are available and when upgrades start and finish.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Result of registering a
                callback.
    ...
    def deregister_callback(self,
        ...
        Args:
            account (str): Account identifier in "##########-#####".
            service (CallbackServiceEnum): Callback type. Must be 'Fota' for Software
                Management Services API.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Callback successfully
                deregistered.
