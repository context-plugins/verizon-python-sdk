...
from verizon.models.consent_transaction_id import (
...
from verizon.models.get_account_device_consent import (
...
class ExclusionsController(BaseController):
    ...
    def devices_location_get_consent_async(self,
                                           account_name,
                                           device_id=None):
        """Perform a GET request to /devicelocations/action/consents.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. List of JSON objects,
                each containing the position data or an error for a device in the
                request.
    ...
    def devices_location_give_consent_async(self,
                                            body=None):
        """Perform a POST request to /devicelocations/action/consents.
    ...
    def devices_location_update_consent(self,
                                        body=None):
        """Perform a PUT request to /devicelocations/action/consents.
    ...
    def exclude_devices(self,
        ...
        Args:
            body (ConsentRequest): Request to update account consent exclusion list.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Success response.
    ...
    def remove_devices_from_exclusion_list(self,
        ...
        Args:
            account_name (str): The numeric name of the account.
            device_list (str): A list of the device IDs to remove from the exclusion
                list.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Devices successfully
                removed from list.
    ...
    def list_excluded_devices(self,
                              account_name,
                              start_index):
        """Perform a GET request to /consents/{accountName}/index/{startIndex}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Excluded devices result.
