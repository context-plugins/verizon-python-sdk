...
from verizon.models.dto_query_metrics_response import (
...
class SensorInsightsSmartAlertMetricsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize SensorInsightsSmartAlertMetricsController object."""
        super(SensorInsightsSmartAlertMetricsController, self).__init__(config)

    def sensorinsightsmetricsquery(self,
                                   body):
        """Perform a POST request to /dm/v1/smartAlerts/actions/metrics.
