...
class DeviceReportsController(BaseController):
    ...
    def calculate_aggregated_report_synchronous(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                ...
                shows session and usage details for up to 10 devices.
    ...
    def calculate_aggregated_report_asynchronous(self,
        ...
        Args:
            body (AggregateSessionReportRequest): Aggregated session report request.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. A successful response
                shows the request is queued with a unique `txid` to identify the
                report data with.
