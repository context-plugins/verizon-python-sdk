...
from verizon.models.dto_sensor_off_boarding_status_response import (
    DtoSensorOffBoardingStatusResponse,
)
from verizon.models.dto_sensor_on_boarding_status_response import (
...
class SensorInsightsSensorsController(BaseController):
    ...
    def __init__(self, config):
        """Initialize SensorInsightsSensorsController object."""
        super(SensorInsightsSensorsController, self).__init__(config)

    def sensor_insights_list_sensor_devices_request(self,
                                                    body):
        """Perform a POST request to /dm/v1/devices/sensors/actions/query.
    ...
    def sensor_insights_on_board_sensor_request(self,
                                                body):
        """Perform a POST request to /dm/v1/devices/sensors/onboard.
    ...
    def sensor_insights_sensor_on_board_status_request(self,
        ...
        Args:
            body (DtoSensorOnBoardStatusRequest): Get the sensor's onboarding status
    ...
    def sensor_insights_off_board_sensor_request(self,
                                                 body):
        """Perform a POST request to /dm/v1/devices/sensors/offboard.
    ...
    def sensor_insights_sensor_off_boarding_status_request(self,
        ...
        Args:
            body (DtoSensorOffBoardStatusRequest): Get a sensor's offboarding status
