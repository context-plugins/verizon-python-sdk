...
class DeviceServiceManagementController(BaseController):
    ...
    def get_device_hyper_precise_status(self,
        ...
        Args:
            ...
            account_number (str): The numeric name of the account and must include
                leading zeroes.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns the status of
                Hyper Precise Location on the device.
    ...
    def update_device_hyper_precise_status(self,
        ...
        Args:
            body (BullseyeServiceRequest): List of devices and hyper-precise required
                statuses.
