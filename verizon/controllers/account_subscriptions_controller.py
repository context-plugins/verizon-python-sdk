...
class AccountSubscriptionsController(BaseController):
    ...
    def list_account_subscriptions(self,
        ...
        purchased for your account by license type, and lists the number of licenses
        assigned and available for each license type.

        Args:
            body (SecuritySubscriptionRequest): Request for account subscription.
            x_request_id (str, optional): Transaction Id.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Security subscription
                result.
