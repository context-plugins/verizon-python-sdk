...
class SessionManagementController(BaseController):
    ...
    def start_connectivity_management_session(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. VZ-M2M session token.
    ...
    def reset_connectivity_management_password(self,
        ...
        Args:
            body (SessionResetPasswordRequest): Request with current password that
                needs to be reset.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Returns a new, randomly
                generated password for the current username.
