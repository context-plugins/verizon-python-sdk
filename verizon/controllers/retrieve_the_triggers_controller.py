...
class RetrieveTheTriggersController(BaseController):
    ...
    def get_all_available_triggers(self):
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Status of Request
    ...
    def get_all_triggers_by_trigger_category(self):
        ...
        Retrieves all of the triggers for the specified account associated with the
        PromoAlert category

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Request response
