...
class DevicesLocationSubscriptionsController(BaseController):
    ...
    def get_location_service_subscription_status(self,
                                                 account_name):
        """Perform a GET request to /subscriptions/{accountName}.
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Device location
    ...
    def get_location_service_usage(self,
        ...
        This endpoint allows user to search for billable usage for accounts based on
        the provided date range.

        Args:
            body (BillUsageRequest): Request to obtain billable usage for accounts.

        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Billable usage report.
