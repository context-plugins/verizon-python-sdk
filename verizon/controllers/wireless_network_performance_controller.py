...
class WirelessNetworkPerformanceController(BaseController):
    ...
    def near_real_time_network_conditions(self,
        ...
        Args:
            body (GetNetworkConditionsRequest): Request for current network health.
        ...
        return super().new_api_call_builder.request(
            ...
            .body_param(Parameter()
                ...
                .validator(lambda value: UnionTypeLookUp
                    .get("Domestic4GAnd5GNationwideNetworkCoverageBody").validate(value)))
            .header_param(Parameter()
                .key("accept")
                .value("application/json"))
            .body_serializer(APIHelper.json_serialize)
    ...
    def site_proximity(self,
        ...
        Args:
            body (GetNetworkConditionsRequest): Request for cell site proximity.
    ...
    def device_experience_30_days_history(self,
        ...
        Args:
            body (GetDeviceExperienceScoreHistoryRequest): Request for a device's 30
                day experience.
    ...
    def device_experience_bulk_latest(self,
        ...
        Args:
            body (GetDeviceExperienceScoreBulkRequest): Request for bulk latest
                history details.
