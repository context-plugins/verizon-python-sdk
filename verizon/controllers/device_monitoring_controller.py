...
class DeviceMonitoringController(BaseController):
    ...
    def device_reachability(self,
        ...
        Args:
            body (NotificationReportRequest): Create Reachability Report Request
    ...
    def stop_device_reachability(self,
        ...
        Args:
            stopreachabilitypayload (StopMonitorRequest): Payload for the Stop Device
                Reachability monitors request.
