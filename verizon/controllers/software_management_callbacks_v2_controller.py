...
class SoftwareManagementCallbacksV2Controller(BaseController):
    ...
    def list_registered_callbacks(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Return callback
                registration.
    ...
    def update_callback(self,
        ...
        Args:
            account (str): Account identifier.
            body (FotaV2CallbackRegistrationRequest): Callback URL registration.
    ...
    def deregister_callback(self,
        ...
        Returns:
            ApiResponse: An object with the response value as well as other useful
                information such as status codes and headers. Result of deregistering
                a callback.
