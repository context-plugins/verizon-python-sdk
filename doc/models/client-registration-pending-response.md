...
```python
from verizon.models.client_registration_pending_response import ClientRegistrationPendingResponse

client_registration_pending_response = ClientRegistrationPendingResponse(
