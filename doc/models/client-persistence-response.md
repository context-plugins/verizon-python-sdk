...
client_persistence_response = ClientPersistenceResponse(
    device_id='a4fcd16a-343d-4527-8203-2f46e3e4ff4b',
    certificate=Certificate(
        cert_pem='cert.pem8',
        key_pem='key.pem8',
        ca_pem='ca.pem6',
        expiration_time=dateutil.parser.parse('2016-03-13T12:52:32.123Z')
    ),
    client_type=EtxClientTypeEnum.TRAFFICLIGHTCONTROLLER,
    client_subtype=ClientSubtypeEnum.PASSENGERCAR,
