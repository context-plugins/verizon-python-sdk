...
|  --- | --- | --- | --- |
| `page` | `str` | Required | Opaque pagination token for fetching the next/previous page of results.<br>This is a encoded string. Do not parse or modify; pass it as received.<br><br>**Constraints**: *Maximum Length*: `4096`, *Pattern*: `^[A-Za-z0-9_-]+={0,2}$` |

## Example

```python
from verizon.models.pagination_filter import PaginationFilter
