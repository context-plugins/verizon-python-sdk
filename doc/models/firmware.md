...
firmware = Firmware(
    ...
    participant_name='0402196254-00001',
    launch_date=dateutil.parser.parse('2018-04-01T16:03:00.000Z'),
    release_note='',
    model='Model-A',
    make='Verizon',
    from_version='VerizonFirmwareVersion-01',
    to_version='VerizonFirmwareVersion-02'
)
```
