...
| `publish` | `List[str]` | Optional | **Constraints**: *Minimum Items*: `0`, *Maximum Items*: `1000`, *Unique Items Required*, *Minimum Length*: `1`, *Maximum Length*: `1000`, *Pattern*: `^[a-zA-Z0-9_$\{\}*\/^\|.-]+$` |
| `subscribe` | `List[str]` | Optional | **Constraints**: *Minimum Items*: `0`, *Maximum Items*: `1000`, *Unique Items Required*, *Minimum Length*: `1`, *Maximum Length*: `1000`, *Pattern*: `^[a-zA-Z0-9_$\{\}*\/^\|.-]+$` |
