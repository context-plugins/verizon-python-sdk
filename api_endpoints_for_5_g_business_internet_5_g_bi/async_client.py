...
class AsyncApiEndpointsFor5GBusinessInternet5GBiClient(BaseApiEndpointsFor5GBusinessInternet5GBiClient[AsyncRawClient]):
    def __init__(
        self,
        *,
    ...
    async def business_internet_serviceplanchange(
        ...
        return (
            await self.with_raw_response.business_internet_serviceplanchange(body, request_options=request_options)
        ).unwrap()
    ...
    async def business_internetactivate_using_post(
        ...
        *,
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.business_internetactivate_using_post(body, request_options=request_options)
        ).unwrap()
    ...
    async def business_internetlist_device_information(
        ...
        Raises:
            ApiError: If the API responds with an error status code. ``error`` is ``RawError``."""
        return (
            await self.with_raw_response.business_internetlist_device_information(body, request_options=request_options)
        ).unwrap()
...
class AsyncApiWithRawResponse(SecuredRawResponse[AsyncRawClient, Server, AsyncAuthSchemes]):
    async def business_internet_serviceplanchange(
        ...
        return await self._client.execute(
            ...
            auth_scheme=AsyncAnySchemes(self._auth.thingspace_oauth, self._auth.vz_m2m_session_token),
...
AsyncClient = AsyncApiEndpointsFor5GBusinessInternet5GBiClient
